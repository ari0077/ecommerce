    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div>
                ...
                <input class="text_color" type="number" name="price" placeholder="Write a title">
            </div>
            <div>
                <label>Product Quantity</label>

                <input class="text_color" type="number" min="0" name="quantity" placeholder="Write a title">
            </div>
            <div>
